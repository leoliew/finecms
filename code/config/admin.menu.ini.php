...
return array(
	...
	'weixin' => array(
		...
		'icon' => 'weixin',
		'menu' => array(
			270 => array('name' => lang('dr019'), 'url' => url('admin/wx/config'),    'icon' => 'cog'),
			274 => array('name' => lang('dr020'), 'url' => url('admin/wx/index'),    'icon' => 'weixin'),
			271 => array('name' => lang('dr021'), 'url' => url('admin/wx/keyword'),    'icon' => 'tag'),
			272 => array('name' => lang('dr023'), 'url' => url('admin/wx/menu'),    'icon' => 'table'),
			273 => array('name' => lang('dr024'), 'url' => url('admin/wx/user'),    'icon' => 'user'),
		)
	),
	'theme' => array(
		'name' => '模板管理',
